  ...
  return (
    <div>
        ...
        <ul>
            ...
            <li>2. Set the Pomodoro® for 25 minutes</li>
            <li>3. Work on the task until the Pomodoro® rings</li>
            <li>4. When the Pomodoro® rings, put a checkmark on a paper</li>
            <li>5. Take a short break</li>
            <li>6. Every 4 pomodoros, take a longer break</li>
        </ul>
    </div>
  )
}

export default PomoDirections
